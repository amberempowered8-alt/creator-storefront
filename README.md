...
Log into your free Airtable account.
Open your Master Core Blueprint link: Airtable Base Blueprint.
Click "Duplicate Base" in the top-right corner to save the database structure into your personal workspace.
Add a test row inside the Resources table:
...
Open app.js in your code/text editor, or directly on GitHub by clicking the file, then the pencil icon (top right) to open the editor.
...
Go to the Airtable Token Developer Hub and click "Create New Token".
...
Click Create Token, copy the token string starting with pat..., and paste it into app.js replacing 'PASTE_YOUR_SECRET_TOKEN_HERE'.
If editing directly on GitHub, scroll down and click "Commit changes" — this is what actually saves your edits. If you don't commit, your changes won't be saved.
...
Create a new repository named after your brand or project (set visibility to Public).
Upload index.html, style.css, and app.js into the root directory.
Click Settings > Pages on your repository navbar.
Under Build and deployment, set the Branch dropdown to main and folder to / (root), then click Save.
Your storefront will be live globally at https://YOUR_GITHUB_USERNAME.github.io/YOUR_REPO_NAME/ shortly after.
...
Scroll to Custom domain, enter your domain (e.g., www.yourdomain.com), and click Save.
Check the box for Enforce HTTPS — this turns on your free SSL security certificate.
2. Update your domain's DNS settings: Log into your domain provider's DNS management panel and add:
...
Scroll to Custom domain, enter your domain name (e.g., www.yourbrand.com), and click Save.
Check the box for Enforce HTTPS to enable your free SSL security certificate 🔒.
